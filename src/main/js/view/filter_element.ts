    ...
    private addAllNoneSelector(): void {
        ...
        buttonBar.append(`
            <div class="nav-bar _filter-nav-bar">
                <a id="${this.id}-btn-all" class="nav-btn _img-filter-all" href="#" tabindex="-1" title="Select all"></a>
                <a id="${this.id}-btn-off" class="nav-btn nav-btn-activator _img-filter-off nav-btn-on" href="#" tabindex="-1" title="Disable filter"></a>
            </div>
        `);
