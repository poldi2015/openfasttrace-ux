...
* [OpenFastTrace UX with Sample requirements](playground/sampledata/openfasttrace.html)
* [OpenFastTrace UX with requirements from the OpenFastTrace repository](playground/oftsadata/openfasttrace.html)
